    ...
    public function run(): void
    {
        $branches = [
            ...
            [
                'order' => 1,
                'status' => 1,
                'title' => 'Chhaya Production Lagankhel',
                'short_description' => 'Chhaya Production branch in Lagankhel, near Mangal Bazaar.',
            ...
            [
                'order' => 2,
                'status' => 1,
                'title' => 'Chhaya Production Itahari',
                'short_description' => 'Chhaya Production branch in Itahari, offering educational services.',
            ...
            [
                'order' => 3,
                'status' => 1,
                'title' => 'Chhaya Production Damak',
                'short_description' => 'Chhaya Production branch in Damak, opposite Global IME Bank.',
            ...
            [
                'order' => 4,
                'status' => 1,
                'title' => 'Chhaya Production Biratnagar',
                'short_description' => 'Chhaya Production branch in Biratnagar at Mahendra Chowk.',
            ...
            [
                'order' => 5,
                'status' => 1,
                'title' => 'Chhaya Production Kathmandu',
                'short_description' => 'Chhaya Production branch in Kathmandu near Chabahil Stupa.',
