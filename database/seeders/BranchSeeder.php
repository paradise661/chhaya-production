    ...
    public function run(): void
    {
        $branches = [
            ...
            [
                'order' => 1,
                'status' => 1,
                'title' => 'Destination Marker Lagankhel',
                'short_description' => 'Destination Marker branch in Lagankhel, near Mangal Bazaar.',
                ...
                'email' => 'destinationeducare@gmail.com',
            ...
            [
                'order' => 2,
                'status' => 1,
                'title' => 'Destination Marker Itahari',
                'short_description' => 'Destination Marker branch in Itahari, offering educational services.',
                ...
                'email' => 'destinationdocuments@gmail.com',
            ...
            [
                'order' => 3,
                'status' => 1,
                'title' => 'Destination Marker Damak',
                'short_description' => 'Destination Marker branch in Damak, opposite Global IME Bank.',
                ...
                'email' => 'destinationdamak@gmail.com',
            ...
            [
                'order' => 4,
                'status' => 1,
                'title' => 'Destination Marker Biratnagar',
                'short_description' => 'Destination Marker branch in Biratnagar at Mahendra Chowk.',
                ...
                'email' => 'destinationbiratnagar@gmail.com',
            ...
            [
                'order' => 5,
                'status' => 1,
                'title' => 'Destination Marker Kathmandu',
                'short_description' => 'Destination Marker branch in Kathmandu near Chabahil Stupa.',
                'description' => 'Situated at Chabahil Stupa, Kathmandu, Nepal, offering a range of educational services and consultancy.',
                'email' => 'destinationeducarechabahil@gmail.com',
